...
Feature: Nopcommerce registration feature Test
  ...
  Scenario Outline: User should be able to registration new account successfully
    ...
    Examples:
      ...
      | "Male"   | "20/05/1995" | "test1@gmail.com" | "Brainstation-23" | "checked"   | "pass@1234" | "Your registration completed" |
      | "Female" | "9/05/1999"  | "test2@gmail.com" | "Brainstation-23" | "unchecked" | "pass@1234" | "Your registration completed" |
      | "Female" | "3/05/2000"  | "test3@gmail.com" | "Brainstation-23" | "unchecked" | "pass@1234" | "Your registration completed" |
      | "Male"   | "2/05/2001"  | "test4@gmail.com" | "Brainstation-23" | "checked"   | "pass@1234" | "Your registration completed" |
      | "Female" | "10/05/1990" | "test5@gmail.com" | "Brainstation-23" | "unchecked" | "pass@1234" | "Your registration completed" |
